    ...
    extend: {
      ...
      colors: {
        ...
        "table-custom": {
          ...
          "row-text": "hsl(var(--table-row-text))",
        ...
        argon: {
          ...
          emerald: "hsl(var(--argon-emerald))",
          teal: "hsl(var(--argon-teal))",
          orange: "hsl(var(--argon-orange))",
          red: "hsl(var(--argon-red))",
          yellow: "hsl(var(--argon-yellow))",
        },
      },
      borderRadius: {
